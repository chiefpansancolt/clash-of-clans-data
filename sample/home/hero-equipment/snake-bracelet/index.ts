...
for (const lvl of e.levels) {
  log(
    `  ${lvl.level}: Snakes:${lvl.stats['maxSummonedSnakes']} SnakeLvl:${lvl.stats['snakeLevel']} ` +
      `DPS+${lvl.stats['dpsIncrease']} HP+${lvl.hitpointIncrease} AtkSpd:${lvl.stats['attackSpeedIncrease']} ` +
