...
const mortor: Defense = {
	...
	townHallDetails: [
		...
		{ townHallLevel: 11, availableCount: 4, maxLevel: 10 },
		{ townHallLevel: 12, availableCount: 4, maxLevel: 12 },
		{ townHallLevel: 13, availableCount: 4, maxLevel: 13 },
		{ townHallLevel: 14, availableCount: 4, maxLevel: 14 },
		{ townHallLevel: 15, availableCount: 4, maxLevel: 15 },
		{ townHallLevel: 16, availableCount: 4, maxLevel: 16 },
	],
	achievement: [
		{
			name: 'High Gear',
