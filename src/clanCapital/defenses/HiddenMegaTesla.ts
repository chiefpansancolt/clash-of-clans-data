...
const hiddenMegaTesla: HiddenMegaTesla = {
	...
	description: "What happens when a Hidden Tesla goes Mega? It's powerful jolt deals heavy damage to even the toughest units!'",
	minRange: 0,
	maxRange: 6,
    triggerRange: 6,
	tiles: 0,
	...
	levels: [
        {
            ...
            clanCapitalLevel: 4,
            districtHallLevel: 1,
            baseImgUrl: 'https://static.wikia.nocookie.net/clashofclans/images/0/08/Hidden_Mega_Tesla1.png/revision/latest/scale-to-width-down/100?cb=20231217065724'
        },
        {
            level: 2,
            damagePerSecond: 175,
            ...
            clanCapitalLevel: 5,
            districtHallLevel: 2,
            baseImgUrl: 'https://static.wikia.nocookie.net/clashofclans/images/d/dc/Hidden_Mega_Tesla2.png/revision/latest/scale-to-width-down/100?cb=20231224100013'
        },
        {
            level: 3,
            damagePerSecond: 200,
            ...
            clanCapitalLevel: 6,
            districtHallLevel: 3,
            baseImgUrl: 'https://static.wikia.nocookie.net/clashofclans/images/9/99/Hidden_Mega_Tesla3.png/revision/latest/scale-to-width-down/100?cb=20231224100025'
        },
        {
            level: 4,
            damagePerSecond: 225,
            ...
            clanCapitalLevel: 8,
            districtHallLevel: 4,
            baseImgUrl: 'https://static.wikia.nocookie.net/clashofclans/images/d/d1/Hidden_Mega_Tesla4.png/revision/latest/scale-to-width-down/100?cb=20231217065736'
        },
        {
            level: 5,
            damagePerSecond: 250,
            ...
            clanCapitalLevel: 10,
            districtHallLevel: 5,
            baseImgUrl: 'https://static.wikia.nocookie.net/clashofclans/images/c/cc/Hidden_Mega_Tesla5.png/revision/latest/scale-to-width-down/100?cb=20231217065740'
        }
    ],
	getSize(): string {
